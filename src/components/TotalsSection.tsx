    ...
    <div className="grid grid-cols-3 gap-4 mb-6" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="bg-blue-50/50 dark:bg-blue-900/20 backdrop-blur-sm rounded-xl p-6 shadow-sm border border-blue-100 dark:border-blue-800">
        <div className="text-center">
          <div className="text-gray-600 dark:text-gray-300 text-lg mb-2 font-bold">{t('commission.totalAmount')}</div>
      ...
      <div className="bg-green-50/50 dark:bg-green-900/20 backdrop-blur-sm rounded-xl p-6 shadow-sm border border-green-100 dark:border-green-800">
        <div className="text-center">
          <div className="text-gray-600 dark:text-gray-300 text-lg mb-2 font-bold">{t('commission.totalCommission')}</div>
          <div className="text-4xl font-bold text-green-700 dark:text-green-500">
            {formatNumber(totalCommission)}
          </div>
        </div>
      </div>
      <div className="bg-purple-50/50 dark:bg-purple-900/20 backdrop-blur-sm rounded-xl p-6 shadow-sm border border-purple-100 dark:border-purple-800">
        <div className="text-center">
          <div className="text-gray-600 dark:text-gray-300 text-lg mb-2 font-bold">{t('commission.total')}</div>
